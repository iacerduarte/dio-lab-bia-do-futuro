...
| `produtos_financeiros.json` | JSON | Conhecer os produtos disponíveis para que eles sejam ensinados ao cliente. |
...
O produto Fundo Imobiliario (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas do Edu de forma mais assertiva.
...
[
  ...
  },
  {
    ...
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "dividendos mensais (Dividend Yield) costuma ficar entre 8% e 12% ao ano",
    "aporte_minimo": 100.00,
...
DADOS DO CLIENTE:
Nome: João SilvaPerfil: Moderado
